    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-2 mb-6">
        <div className="flex flex-col gap-1 flex-1">
          ...
          <input type="date" value={start} onChange={e=>setStart(e.target.value)} className="rounded-xl border border-slate-200 text-sm px-3 py-2 outline-none focus:border-[#141414] w-full [color-scheme:light]" placeholder="åååå-mm-dd"/>
        </div>
        <div className="flex flex-col gap-1 flex-1">
          <label className="text-xs text-slate-500 font-medium">Till</label>
          <input type="date" value={end} onChange={e=>setEnd(e.target.value)} className="rounded-xl border border-slate-200 text-sm px-3 py-2 outline-none focus:border-[#141414] w-full [color-scheme:light]" placeholder="åååå-mm-dd"/>
        </div>
