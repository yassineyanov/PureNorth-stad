              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                {inv.status === "draft" ? (
                  ...
                  <>
                    ...
                    <button onClick={() => createKreditfaktura(inv)} title="Skapa kreditfaktura" className="inline-flex items-center gap-1 text-xs font-semibold text-orange-600 border border-orange-200 hover:bg-orange-50 rounded-lg px-2 py-1 transition-colors">
                      Kreditfaktura
                    </button>
                  </>
                )}
