...
export const AboutSection = () => {
  ...
  return (
    <section id="om-oss" className="py-24 sm:py-28 bg-[#f9fafb]">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200"
              alt="PureNorth Städ team"
          ...
          >
            ...
            <h2 className="font-display font-bold text-4xl sm:text-5xl tracking-tight text-[#141414] mt-3 mb-6">
