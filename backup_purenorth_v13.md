# PureNorth Backup v13 — 2026-07-07 — Security hardened + CORS locked + JWT 24h
## login/bookings/reviews rate-limited, inputs sanitized, secrets rotated, .env out of git, CORS restricted to prod domains, JWT expiry 24h
